...
struct AsyncOutfitPickerTests {
    ...
    func asyncShowRandomOutfit_returnsOutfit() async throws {
        let env = try makeOutfitPickerSUT(
            ...
            fileSystem: [
                URL(filePath: "/Users/test/Outfits", directoryHint: .isDirectory): [
                    URL(filePath: "/Users/test/Outfits/Casual", directoryHint: .isDirectory)
                ],
                URL(filePath: "/Users/test/Outfits/Casual", directoryHint: .isDirectory): [
                    URL(filePath: "/Users/test/Outfits/Casual/outfit1.avatar", directoryHint: .notDirectory)
                ]
            ],
            directories: [
                URL(filePath: "/Users/test/Outfits", directoryHint: .isDirectory),
    ...
    func asyncShowRandomOutfit_returnsNilForEmpty() async throws {
        let env = try makeOutfitPickerSUT(
            ...
            fileSystem: [
                URL(filePath: "/Users/test/Outfits", directoryHint: .isDirectory): [
                    URL(filePath: "/Users/test/Outfits/Empty", directoryHint: .isDirectory)
                ],
                URL(filePath: "/Users/test/Outfits/Empty", directoryHint: .isDirectory): []
            ],
            directories: [
    ...
    func asyncGetAvailableCount_returnsCount() async throws {
        let env = try makeOutfitPickerSUT(
            ...
            fileSystem: [
                ...
                URL(filePath: "/Users/test/Outfits/Casual", directoryHint: .isDirectory): [
                    URL(filePath: "/Users/test/Outfits/Casual/outfit1.avatar", directoryHint: .notDirectory),
                    URL(filePath: "/Users/test/Outfits/Casual/outfit2.avatar", directoryHint: .notDirectory)
                ]
            ],
            directories: [
                URL(filePath: "/Users/test/Outfits", directoryHint: .isDirectory),
    ...
    func asyncShowAllOutfits_returnsAll() async throws {
        ...
        #expect(outfits.map(\.fileName).sorted() == ["outfit1.avatar", "outfit2.avatar"])
    }
    ...
    func asyncDetectChanges_detectsChanges() async throws {
        ...
        let env = try makeOutfitPickerSUT(
            ...
            fileSystem: [
                URL(filePath: "/Users/test/Outfits", directoryHint: .isDirectory): [
                    URL(filePath: "/Users/test/Outfits/New", directoryHint: .isDirectory)
                ],
                URL(filePath: "/Users/test/Outfits/New", directoryHint: .isDirectory): [
                    URL(filePath: "/Users/test/Outfits/New/new.avatar", directoryHint: .notDirectory)
                ]
            ],
            directories: [
                URL(filePath: "/Users/test/Outfits", directoryHint: .isDirectory),
    ...
    func asyncMethods_propagateErrors() async {
        ...
        do {
            let outfit = makeOutfitReference(root: "/test", category: "Test", fileName: "test.avatar")
